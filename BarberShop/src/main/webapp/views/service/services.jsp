...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            * {
            ...
            .category-mini-item:hover, .category-mini-item.active {
                background: #1a1a2e;
                color: #ffd700;
            }
    ...
    <body>
        ...
        <div class="service-layout" style="display: flex; gap: 24px; align-items: flex-start;">
            <!-- Category Sidebar -->
            <div class="category-mini-sidebar">
            ...
            <div class="main-container">
                ...
                <section class="service-section" id="category-2">
                    <div class="section-header">
                ...
                <section class="service-section" id="category-3">
                    <div class="section-header">
                ...
                <section class="service-section" id="category-4">
                    <div class="section-header">
                ...
                <section class="service-section" id="category-5">
                    <div class="section-header">
        ...
        <script>
            ...
            function filterByCategory(categoryId, el) {
                // Bỏ active ở tất cả filter-item và mini-item
