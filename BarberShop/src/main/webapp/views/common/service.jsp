...
<div class="container py-5 service-sections">
    ...
    <div class="row mb-4">
        <div class="col-md-4 mb-3">
            <a href="${pageContext.request.contextPath}/CutHairServiceServlet" class="service-card">
        ...
        <div class="col-md-4 mb-3">
            <a href="${pageContext.request.contextPath}/HairServiceServlet" class="service-card">
    ...
    <div class="row">
        <div class="col-md-4 mb-3">
            <a href="${pageContext.request.contextPath}/MassageService" class="service-card">
