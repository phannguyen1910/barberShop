    ...
    <body>
        ...
        <div class="dashboard-layout">
            ...
            <nav class="sidebar" id="sidebar" aria-label="Menu điều hướng">
                ...
                <div class="nav-menu">
                    <div class="nav-item"><a href="${pageContext.request.contextPath}/views/staff/registerForAShift.jsp" class="nav-link" aria-label="Đăng ký lịch làm việc"><i class="fas fa-calendar-alt"></i><span>Đăng ký Lịch Nghỉ</span></a></div>
