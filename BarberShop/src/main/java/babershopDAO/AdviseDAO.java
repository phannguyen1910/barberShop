    ...
    public List<Advise> searchAdvises(String keyword) throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                advise.setServiceId(rs.getInt("service_id"));
                advise.setType(rs.getString("type"));
                advise.setTargetAge(rs.getString("target_age"));
                advise.setFaceShape(rs.getString("face_shape"));
                advise.setMinPrice((Integer)rs.getObject("min_price"));
                advise.setMaxPrice((Integer)rs.getObject("max_price"));
                advise.setDuration((Integer)rs.getObject("duration"));
                advise.setColorFadeTime((Integer)rs.getObject("color_fade_time"));
