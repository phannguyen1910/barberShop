...
<html>
    ...
    <body>
        ...
        <div class="container text-center py-4">
            ...
            <div class="mb-4">
                <img src="${pageContext.request.contextPath}/image/combo4/banner.png" class="img-fluid rounded shadow" alt="Combo Banner">
            </div>
            ...
            <div class="text-start mt-5">
                ...
                <div class="process-grid">
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/1.png" class="img-fluid process-img shadow-sm mb-2" alt="Thư giãn đá nóng">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Thư giãn đá nóng</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/2.png" class="img-fluid process-img shadow-sm mb-2" alt="Quấn đai nóng">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Quấn đai nóng</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/3.png" class="img-fluid process-img shadow-sm mb-2" alt="Thư giãn da mặt">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Thư giãn da mặt</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/4.png" class="img-fluid process-img shadow-sm mb-2" alt="Rửa mặt">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Rửa mặt</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/5.png" class="img-fluid process-img shadow-sm mb-2" alt="Chăm sóc da mặt">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Chăm sóc da mặt</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/6.png" class="img-fluid process-img shadow-sm mb-2" alt="Hút mụn">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Hút mụn</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/7.png" class="img-fluid process-img shadow-sm mb-2" alt="Phun hoa hồng">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Phun hoa hồng</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/8.png" class="img-fluid process-img shadow-sm mb-2" alt="Gội đầu">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Gội đầu</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/9.png" class="img-fluid process-img shadow-sm mb-2" alt="Thư giãn vùng đầu">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Thư giãn vùng đầu</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/10.png" class="img-fluid process-img shadow-sm mb-2" alt="Rửa tai & Ngoáy tai">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Rửa tai & Ngoáy tai</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/11.png" class="img-fluid process-img shadow-sm mb-2" alt="Xối nước thác đổ">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Xối nước thác đổ</p>
                    </div>
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/12.png" class="img-fluid process-img shadow-sm mb-2" alt="Thư giãn tay">
                        <p class="mb-0 fw-bold" style="color: #201E15;">Thư giãn tay</p>
                    </div>                                    
                    <div class="process-item">
                        <img src="${pageContext.request.contextPath}/image/combo4/14.png" class="img-fluid process-img shadow-sm mb-2" alt="Cắt tóc">
