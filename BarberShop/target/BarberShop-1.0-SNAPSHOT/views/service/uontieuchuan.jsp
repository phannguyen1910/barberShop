    ...
    <body>
        ...
        <div class="container text-center py-4">
            ...
            <div class="text-start mt-5">
                ...
                <p class="text-muted mb-4 fw-bold" style="color: #201E15;">Sử dụng thuốc uốn ATS cao cấp, bộ súng thổi dùng chất phục hồi tóc. Thường được các KOLs, Celeb tin dùng.</p>
                <div class="row row-cols-2 row-cols-md-4 g-4">
                    <div class="col">
                        <div class="process-item text-center">
                            <img src="${pageContext.request.contextPath}/image/uontieuchuan/1.jpg" class="img-fluid rounded shadow-sm mb-2" alt="Kiểm tra & đánh giá chất tóc">
                            <p class="mb-0 fw-bold" style="color: #000000;">Kiểm tra & đánh giá chất tóc</p>
                        </div>
                    </div>
                    <div class="col">
                        <div class="process-item text-center">
                            <img src="${pageContext.request.contextPath}/image/uontieuchuan/2.jpg" class="img-fluid rounded shadow-sm mb-2" alt="Uốn tóc">
                            <p class="mb-0 fw-bold" style="color: #000000;">Uốn tóc</p>
                        </div>
                    </div>
                    <div class="col">
                        <div class="process-item text-center">
                            <img src="${pageContext.request.contextPath}/image/uontieuchuan/3.jpg" class="img-fluid rounded shadow-sm mb-2" alt="Xả tóc">
                            <p class="mb-0 fw-bold" style="color: #000000;">Xả tóc</p>
                        </div>
                    </div>
                    <div class="col">
                        <div class="process-item text-center">
                            <img src="${pageContext.request.contextPath}/image/uontieuchuan/4.jpg" class="img-fluid rounded shadow-sm mb-2" alt="Sấy vuốt tạo kiểu">
